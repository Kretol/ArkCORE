...
const char GameObjectInfodstfmt[] =
        "iiissssiifiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiisii";
...
SQLStorage sGOStorage(GameObjectInfosrcfmt, GameObjectInfodstfmt, "entry",
        "gameobject_template");
